...
//
// Usage:
//   Time::Initialize();                 // once, at engine startup
//   Time::Update();                     // once per frame, at frame start
//   while (Time::ConsumeFixedStep())    // zero or more fixed updates per frame
//       game.FixedUpdate(Time::GetFixedTimestep());
//
// Notes:
