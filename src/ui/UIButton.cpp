...
UIButton::UIButton()
    ...
    , hoverBgColor_(0.3f, 0.4f, 0.6f, 1.0f)
    , pressedBgColor_(0.1f, 0.2f, 0.4f, 1.0f)
    , disabledBgColor_(0.5f, 0.5f, 0.5f, 0.5f)
    , normalTextColor_(1.0f, 1.0f, 1.0f, 1.0f)    // White text
    , hoverTextColor_(1.0f, 1.0f, 1.0f, 1.0f)
    , pressedTextColor_(1.0f, 1.0f, 1.0f, 1.0f)
    , disabledTextColor_(1.0f, 1.0f, 1.0f, 0.5f)
    , iconTexture_(0)
    , text_("")
