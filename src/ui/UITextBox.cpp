...
UITextBox::UITextBox()
    : fontSize_(16.0f), textColor_(1.0f, 1.0f, 1.0f, 1.0f) // White text
      ,
      backgroundColor_(0.2f, 0.2f, 0.2f, 0.8f) // Semi-transparent dark background
      ,
      borderColor_(0.5f, 0.5f, 0.5f, 1.0f) // Gray border
      ,
      borderWidth_(1.0f), passwordMode_(false), maxLength_(-1) // Unlimited by default
      ,
      hasFocus_(false), cursorTimer_(0.0f)
{
